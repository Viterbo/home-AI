...
const srcDirectory = './agents';
const filePrefix = 'home-ai-agents';
const outputFiles = {
    ...
    xml: `${filePrefix}_xml_code.xml`,
    py: `${filePrefix}_python_code.py`,
    Dockerfile: `${filePrefix}_dockerfile`,
    txt: `${filePrefix}_txt_code.txt`,
};
